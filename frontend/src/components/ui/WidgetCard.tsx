...
export function WidgetCard({
  ...
  return (
    <div className="rounded-2xl border border-white/[0.08] bg-white/[0.02] p-4 shadow-[0_0_20px_-12px_color-mix(in_srgb,var(--color-primary)_40%,transparent)] backdrop-blur-2xl transition-colors hover:border-primary/20">
